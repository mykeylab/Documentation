...
Pull up MYKEY for contract calls, support multiple action combination calls, support ContractAction and TransferAction two types of action types. Please refer to the class definition for the parameters [ContractRequest](../../dive-into-mykey/classes-and-methods/#class-contractrequest), [ContractAction](../../dive-into-mykey/classes-and-methods/#class-contractaction), [TransferAction](../../dive-into-mykey/classes-and-methods/#class-transferaction) and [MYKEYResponse](../../dive-into-mykey/classes-and-methods/#class-mykeyresponse).
