...
唤起MYKEY进行认证绑定。参数请详见类定义:[AuthorizeRequest](https://github.com/mykeylab/Documentation/blob/master/Chinese/MYKEY_iOS_SDK.md#class-authorizerequest)和[MYKEYResponse](https://github.com/mykeylab/Documentation/blob/master/Chinese/MYKEY_iOS_SDK.md#class-mykeyresponse)
